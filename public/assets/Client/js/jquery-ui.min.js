...
!(function (t) {
    ...
    (f.cleanData =
        ...
        (f.widget = function (t, i, e) {
            ...
            return (
                e || ((e = i), (i = f.Widget)),
                f.isArray(e) && (e = f.extend.apply(null, [{}].concat(e))),
                (f.expr[":"][l.toLowerCase()] = function (t) {
                    return !!f.data(t, l);
                }),
                (f[r] = f[r] || {}),
                (s = f[r][t]),
                ...
                ((a = new i()).options = f.widget.extend({}, a.options)),
                ...
                s
                    ? (f.each(s._childConstructors, function (t, e) {
                          var i = e.prototype;
                          f.widget(
        ...
        (f.widget.extend = function (t) {
            for (
                var e, i, s = r.call(arguments, 1), n = 0, a = s.length;
                n < a;
                n++
            )
                for (e in s[n])
                    (i = s[n][e]),
                        s[n].hasOwnProperty(e) &&
                            void 0 !== i &&
                            (f.isPlainObject(i)
                                ? (t[e] = f.isPlainObject(t[e])
                                      ? f.widget.extend({}, t[e], i)
                                      : f.widget.extend({}, i))
                                : (t[e] = i));
            return t;
        }),
                ...
                return (
                    t
                        ? this.length || "instance" !== i
                            ...
                            : (n = void 0)
                        : (s.length &&
                              (i = f.widget.extend.apply(null, [i].concat(s))),
                          this.each(function () {
                              var t = f.data(this, o);
                              t
                                  ? (t.option(i || {}), t._init && t._init())
                                  : f.data(this, o, new e(i, this));
                          })),
                    n
                );
            };
        ...
        (f.Widget.prototype = {
            ...
            _createWidget: function (t, e) {
                (e = f(e || this.defaultElement || this)[0]),
                    (this.element = f(e)),
                    (this.uuid = i++),
                    ...
                    e !== this &&
                        (f.data(e, this.widgetFullName, this),
            ...
            destroy: function () {
                var i = this;
                this._destroy(),
                    f.each(this.classesElementLookup, function (t, e) {
                        i._removeClass(e, t);
                    }),
                    this.element
            ...
            option: function (t, e) {
                ...
                if ("string" == typeof t)
                    if (
                        ...
                        for (
                            s = a[t] = f.widget.extend({}, this.options[t]),
                                n = 0;
                            n < i.length - 1;
                            n++
                        )
            ...
            _classes: function (n) {
                ...
                function t(t, e) {
                    for (var i, s = 0; s < t.length; s++)
                        (i = o.classesElementLookup[t[s]] || f()),
                            (i = n.add
                                ? f(f.unique(i.get().concat(n.element.get())))
                                : f(i.not(n.element).get())),
            ...
            _untrackClassesElement: function (i) {
                ...
                f.each(s.classesElementLookup, function (t, e) {
                    -1 !== f.inArray(i.target, e) &&
                        (s.classesElementLookup[t] = f(e.not(i.target).get()));
                });
            },
            ...
            _on: function (n, a, t) {
                ...
                "boolean" != typeof n && ((t = a), (a = n), (n = !1)),
                    t
                        ...
                        : ((t = a), (a = this.element), (o = this.widget())),
                    f.each(t, function (t, e) {
                        ...
                        "string" != typeof e &&
                            (i.guid = e.guid = e.guid || i.guid || f.guid++);
                        var s = t.match(/^([\w:-]*)\s*(.*)$/),
            ...
            _off: function (t, e) {
                (e =
                    ...
                    this.eventNamespace),
                    t.off(e).off(e),
                    (this.bindings = f(this.bindings.not(t).get())),
                    (this.focusable = f(this.focusable.not(t).get())),
                    (this.hoverable = f(this.hoverable.not(t).get()));
            },
            _delay: function (t, e) {
                var i = this;
        ...
        f.each({ show: "fadeIn", hide: "fadeOut" }, function (a, o) {
            f.Widget.prototype["_" + a] = function (e, t, i) {
                var s;
                "string" == typeof t && (t = { effect: t });
                var n = t
                    ? (!0 !== t && "number" != typeof t && t.effect) || o
                    : a;
                "number" == typeof (t = t || {}) && (t = { duration: t }),
                    (s = !f.isEmptyObject(t)),
                    (t.complete = i),
                    t.delay && e.delay(t.delay),
                    s && f.effects && f.effects.effect[n]
                        ? e[a](t)
                        : n !== a && e[n]
    ...
    f.widget("ui.mouse", {
        ...
        _mouseInit: function () {
            ...
            this.element
                ...
                .on("click." + this.widgetName, function (t) {
                    if (
                        !0 ===
                        f.data(t.target, e.widgetName + ".preventClickEvent")
                    )
                        return (
                            f.removeData(
                                t.target,
                ...
                var e = this,
                    ...
                    s =
                        !(
                            ...
                            !t.target.nodeName
                        ) && f(t.target).closest(this.options.cancel).length;
        ...
        f.widget("ui.slider", f.ui.mouse, {
            ...
            _createHandles: function () {
                ...
                (this.handles = i.add(f(s.join("")).appendTo(this.element))),
                    this._addClass(
                        this.handles,
                        "ui-slider-handle",
                        "ui-state-default"
                ...
                t.range
                    ? (!0 === t.range &&
                      ...
                      this.range && this.range.length
                          ...
                          : ((this.range = f("<div>").appendTo(this.element)),
            ...
            _slide: function (t, e, i) {
                ...
                this._hasMultipleValues() &&
                    ...
                    i !== n &&
                        !1 !==
                            this._trigger("slide", t, this._uiHash(e, i, a)) &&
                        (this._hasMultipleValues()
                            ? this.values(e, i)
                            : this.value(i));
            },
            ...
            _handleEvents: {
                keydown: function (t) {
                    var e,
                        i,
                        s,
                        n = f(t.target).data("ui-slider-handle-index");
                    switch (t.keyCode) {
    ...
    function A(s) {
        ...
        return (
            ...
            a.length
                ? ("0,0,0,0" === a.join() && h.extend(a, l.transparent), n)
                : l[s]
        );
    }
    function T(t, e, i) {
    ...
    function P(t) {
        ...
        if (s && s.length && s[0] && s[s[0]])
            for (i = s.length; i--; )
                "string" == typeof s[(e = s[i])] && (n[f.camelCase(e)] = s[e]);
        else for (e in s) "string" == typeof s[e] && (n[e] = s[e]);
        return n;
    }
    function V(t, e, i, s) {
        return (
            f.isPlainObject(t) && (t = (e = t).effect),
            (t = { effect: t }),
            null == e && (e = {}),
            f.isFunction(e) && ((s = e), (i = null), (e = {})),
            ("number" != typeof e && !f.fx.speeds[e]) ||
                ((s = i), (i = e), (e = {})),
    ...
    function W(t) {
        return (
            ...
            "number" == typeof t ||
            f.fx.speeds[t] ||
            ("string" == typeof t && !f.effects.effect[t]) ||
            f.isFunction(t) ||
    ...
    (f.effects = { effect: {} }),
        ...
        (o.rgba = -1 < e.style.backgroundColor.indexOf("rgba")),
        v(g, function (t, e) {
            (e.cache = "_" + t),
        ...
        (p.fn = h.extend(p.prototype, {
            parse: function (n, t, e, i) {
                ...
                var a = this,
                    ...
                    o = (this._rgba = []);
                return (
                    t !== c && ((n = [n, t, e, i]), (s = "array")),
                    "string" === s
                        ? this.parse(A(n) || l._default)
                        : "array" === s
        ...
        (g.hsla.from = function (t) {
            ...
            var e = t[0] / 360,
                ...
                s = 2 * s - i;
            return [
                Math.round(255 * T(s, i, e + 1 / 3)),
                Math.round(255 * T(s, i, e)),
                Math.round(255 * T(s, i, e - 1 / 3)),
                t,
            ];
        }),
        v(g, function (l, t) {
            var a = t.props,
                ...
                u = t.from;
            (p.fn[l] = function (t) {
                if ((r && !this[o] && (this[o] = r(this._rgba)), t === c))
                    return this[o].slice();
                var e,
                    i = h.type(t),
            ...
            v(t, function (t, a) {
                (h.cssHooks[a] = {
                    set: function (t, e) {
                        ...
                        if (
                            "transparent" !== e &&
                            ("string" !== h.type(e) || (i = A(e)))
                        ) {
                            if (
                                ((e = p(i || e)), !o.rgba && 1 !== e._rgba[3])
                            ) {
                                for (
                                    s =
                                        "backgroundColor" === a
        ...
        (f.effects.animateClass = function (n, t, e, i) {
            ...
            return this.queue(function () {
                var i = f(this),
                    t = i.attr("class") || "",
                    e = (e = a.children ? i.find("*").addBack() : i).map(
                        function () {
                            return { el: f(this), start: P(this) };
                        }
                    ),
                    s = function () {
        ...
        f.fn.extend({
            addClass:
                ...
                function (t, e, i, s) {
                    return e
                        ? f.effects.animateClass.call(this, { add: t }, e, i, s)
            ...
            switchClass: function (t, e, i, s, n) {
                return f.effects.animateClass.call(
                    this,
                    { add: e, remove: t },
                    i,
                    s,
        ...
        f.extend(f.effects, {
            ...
            define: function (t, e, i) {
                return (
                    i || ((i = e), (e = "effect")),
                    (f.effects.effect[t] = i),
                    (f.effects.effect[t].mode = e),
                    i
                );
            },
        ...
        f.fn.extend({
                ...
                function t(t) {
                    ...
                    e.data(O, !0),
                        ...
                        a &&
                            ("show" === i || (i === a && "hide" === i)) &&
                            e.show(),
                        (a && "none" === i) || f.effects.saveStyle(e),
                        f.isFunction(t) && t();
                }
            ...
            transfer: function (t, e) {
                var i = f(this),
                    ...
                    s = i.offset(),
                    l = f("<div class='ui-effects-transfer'></div>")
                        .appendTo("body")
        ...
        (k = {}),
        f.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function (e, t) {
            k[t] = function (t) {
    ...
    f.effects,
        f.effects.define("slide", "show", function (t, e) {
            var i,
                s,
                n = f(this),
                a = {
                ...
                c = {};
            f.effects.createPlaceholder(n),
                (i = n.cssClip()),
                (s = n.position()[l]),
                (c[l] = (u ? -1 : 1) * h + s),
                (c.clip = n.cssClip()),
                (c.clip[a[r][1]] = c.clip[a[r][0]]),
                "show" === o &&
                    (n.cssClip(c.clip),
                    n.css(l, c[l]),
                    (c.clip = i),
