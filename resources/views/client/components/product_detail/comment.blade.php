        ...
        <li>
            <div class="cs_client_review">
                <div class="cs_review_media">
                    <div class="cs_review_media_thumb"><img src="{{asset('assets/Client/img/avatar.png')}}" alt="Avatar">
                    </div>
                ...
                <p class="cs_review_text">I recently purchased the Arino T-shirts and I'm thoroughly
                    ...
                    cancellation
                    technology is a <br> standout feature. They're a bit pricey, but well worth the
                    investment. Highly
                    recommend.</p>
            </div>
        </li>
