<section>
    ...
    <div class="container">
        ...
        <ul class="cs_tab_links cs_style_1 cs_mp0">
            <li class="active"><a href="#tab_tshirt" class="cs_fs_16 cs_medium">T-shirt</a></li>
            <li><a href="#tab_jeans" class="cs_fs_16 cs_medium">Jeans</a></li>
            <li><a href="#tab_cshirt" class="cs_fs_16 cs_medium">Casual Shirt</a></li>
            <li><a href="#tab_leggings" class="cs_fs_16 cs_medium">Leggings</a></li>
            <li><a href="#tab_skirts" class="cs_fs_16 cs_medium">Skirts</a></li>
            <li><a href="#tab_shoes" class="cs_fs_16 cs_medium">Shoes</a></li>
            <li><a href="#tab_accessories" class="cs_fs_16 cs_medium">Accessories</a></li>
        </ul>
    </div>
            ...
            <div class="cs_tab active" id="tab_tshirt">
                <div class="cs_slider position-relative cs_hover_arrow">
                    <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600"
                        ...
                        data-md-slides="2" data-lg-slides="3" data-add-slides="4">
                        <div class="cs_slider_wrapper">
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    <div class="cs_product_thumb position-relative">
                                        <img src="{{asset('assets/Client/img/product1.png')}}" alt="Product Image">
                                        <div
                                    ...
                                    <div class="cs_product_info text-center">
                                        ...
                                        <p class="cs_product_price cs_fs_18 cs_accent_color mb-0 cs_medium">$250.00
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    <div class="cs_product_thumb position-relative">
                                        <img src="{{asset('assets/Client/img/product2.png')}}" alt="Product Image">
                                        <div
                                            class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">
                                            -8%</div>
                                        <div class="cs_cart_badge position-absolute">
                                    ...
                                    <div class="cs_product_info text-center">
                                        ...
                                        <p class="cs_product_price cs_fs_18 cs_accent_color mb-0 cs_medium">$220.00
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    <div class="cs_product_thumb position-relative">
                                        <img src="{{asset('assets/Client/img/product3.png')}}" alt="Product Image">
                                        <div
                                            class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">
                                            -12%</div>
                                        <div class="cs_cart_badge position-absolute">
                            ...
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    <div class="cs_product_thumb position-relative">
                                        <img src="{{asset('assets/Client/img/product8.png')}}" alt="Product Image">
                                        <div class="cs_cart_badge position-absolute">
                                            <a href="wishlist.html"
                                                class="cs_cart_icon cs_accent_bg cs_white_color">
                                                <i class="fa-regular fa-heart"></i>
                            ...
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    ...
                                    <div class="cs_product_info text-center">
                                        ...
                                        <p class="cs_product_price cs_fs_18 cs_accent_color mb-0 cs_medium">$350.00
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600"
                        ...
                        <div class="cs_slider_wrapper">
                            ...
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    <div class="cs_product_thumb position-relative">
                                        <img src="{{asset('assets/Client/img/product9.png')}}" alt="Product Image">
                                        <div
                                            class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">
                                            -8%</div>
                                        <div class="cs_cart_badge position-absolute">
                    ...
                    <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600"
                        ...
                        <div class="cs_slider_wrapper">
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    <div class="cs_product_thumb position-relative">
                                        <img src="{{asset('assets/Client/img/product27.png')}}" alt="Product Image">
                                        <div class="cs_cart_badge position-absolute">
                                            <a href="wishlist.html"
                                                class="cs_cart_icon cs_accent_bg cs_white_color">
                                                <i class="fa-regular fa-heart"></i>
                            ...
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    <div class="cs_product_thumb position-relative">
                                        <img src="{{asset('assets/Client/img/product16.png')}}" alt="Product Image">
                                        <div
                                            class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">
                                            -8%</div>
                                        <div class="cs_cart_badge position-absolute">
                            ...
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    <div class="cs_product_thumb position-relative">
                                        <img src="{{asset('assets/Client/img/product28.png')}}" alt="Product Image">
                                        <div class="cs_cart_badge position-absolute">
                                            <a href="wishlist.html"
                                                class="cs_cart_icon cs_accent_bg cs_white_color">
                                                <i class="fa-regular fa-heart"></i>
                    ...
                    <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600"
                        ...
                        <div class="cs_slider_wrapper">
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    <div class="cs_product_thumb position-relative">
                                        <img src="{{asset('assets/Client/img/product10.png')}}" alt="Product Image">
                                        <div class="cs_cart_badge position-absolute">
                                            <a href="wishlist.html"
                                                class="cs_cart_icon cs_accent_bg cs_white_color">
                                                <i class="fa-regular fa-heart"></i>
                            ...
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    <div class="cs_product_thumb position-relative">
                                        <img src="{{asset('assets/Client/img/product11.png')}}" alt="Product Image">
                                        <div
                                            class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">
                                            -12%</div>
                                        <div class="cs_cart_badge position-absolute">
            ...
            <div class="cs_tab" id="tab_accessories">
                <div class="cs_slider position-relative cs_hover_arrow">
                    <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600"
                        ...
                        data-sm-slides="2" data-md-slides="2" data-lg-slides="3" data-add-slides="4">
                        <div class="cs_slider_wrapper">
                            <div class="slick_slide_in">
                                <div class="cs_product cs_style_1">
                                    <div class="cs_product_thumb position-relative">
